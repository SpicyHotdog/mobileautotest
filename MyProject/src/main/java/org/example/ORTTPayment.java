...
public class ORTTPayment {
    @Test
    public void OverSeaPayment(){
        ...
        try{
            ...
            synchronized (driver){
                ...
                Assert.assertNotNull(driver.findElement(AppiumBy.xpath("//XCUIElementTypeStaticText[@name='acknowledgementStatusTitleLabel']")));
                Assert.assertEquals(driver.findElement(AppiumBy.xpath("//XCUIElementTypeStaticText[@name='acknowledgementStatusTitleLabel']")).getText(),"Your instruction has been received. ");
                System.out.println(driver.getPageSource());
                /*
